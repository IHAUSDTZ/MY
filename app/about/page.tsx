    ...
    <div className="pt-32 flex flex-col">
      ...
      <section className="bg-primary text-white py-20 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          <AnimatedHeading className="text-4xl md:text-6xl font-bold mb-6">Our Story & Commitment</AnimatedHeading>
          <AnimatedText delay={0.2} className="text-xl opacity-80 font-light">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12">
          <AnimatedSection 
            ...
            className="bg-surface p-12 rounded-[3rem] shadow-sm"
          >
